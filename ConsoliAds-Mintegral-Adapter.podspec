...
Pod::Spec.new do |s|
  ...
  s.version          = '0.0.1'
  s.summary          = 'ConsoliAds-Mintegral-Adapter  a pod for CAMintegral adapter.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
  'ConsoliAds-Mintegral-Adapter  a pod for CAMintegral adapter.'
                       DESC
...
#  s.source_files = 'ConsoliAds-Mintegral-Adapter/Classes/**/*'
s.vendored_frameworks = 'ConsoliAds-Mintegral-Adapter/ConsoliAdsMintegralAdapter.framework'
...
s.static_framework = true
  # s.resource_bundles = {
  #   'ConsoliAds-Mintegral-Adapter' => ['ConsoliAds-Mintegral-Adapter/Assets/*.png']
  # }
